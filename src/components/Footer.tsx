      ...
      <div className="section-container py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-[#1a1a1a]">
            {SERVICES.map(s => <li key={s.title}><Link href={`/services#${s.id}`} className="hover:text-[#ef4d2b]">{s.title}</Link></li>)}
          </ul>
        </div>
        <div>
          <div className="text-sm uppercase tracking-[0.2em] text-[#ef4d2b] font-semibold mb-4">Practice</div>
          <ul className="space-y-2 text-sm text-[#1a1a1a]">
            <li><Link href="/about" className="hover:text-[#ef4d2b]">About</Link></li>
            <li><Link href="/#how" className="hover:text-[#ef4d2b]">How it works</Link></li>
            <li><Link href="/#philosophy" className="hover:text-[#ef4d2b]">Philosophy</Link></li>
            <li><Link href="/testimonials" className="hover:text-[#ef4d2b]">Testimonials</Link></li>
          </ul>
        </div>
        <div>
