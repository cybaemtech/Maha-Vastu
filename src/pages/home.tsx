    ...
    <header className="fixed top-0 inset-x-0 z-50 bg-white/85 backdrop-blur-xl border-b border-[#f0e6d2]">
      <div className="section-container flex items-center justify-between h-20">
        <Link href="/" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="flex items-center gap-2.5 group" data-testid="nav-logo">
          <img src={logoImg} alt="Shrisat Astro Vastu logo" className="w-20 h-20 rounded-full object-contain" />
...
function Hero() {
  return (
    <section id="top" className="relative overflow-hidden bg-warm-glow pt-32 md:pt-36 pb-20 md:pb-28">
      <HeroBackdrop />
    ...
    <section id="services" className="section-container py-20 md:py-28">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
        <div>
          ...
          <h2 className="font-heading mt-3 text-3xl md:text-5xl font-light tracking-tight text-[#1a1a1a]">Six services, one integrated practice.</h2>
        </div>
